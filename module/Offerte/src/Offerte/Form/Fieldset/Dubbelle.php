...
class Dubbelle extends Fieldset implements InputFilterProviderInterface
{
    public function __construct(ObjectManager $objectManager)
    {
        parent::__construct("dubbelle");
        ...
        $this->add(array(
            ...
            'name'    => 'current_supplier_kwh_low',
            'attributes' => array('class' => 'form-control'),
            'options' => array(
                'label' => 'Current supplier KWH low',
                'column-size' => 'sm-10',
        ...
        $this->add(array(
            'type'    => 'Zend\Form\Element\Text',
            'name'    => 'current_supplier_kwh_low_price',
            'attributes' => array('class' => 'form-control'),
            'options' => array(
                'label' => 'Current supplier KWH low price',
                'column-size' => 'sm-10',
                'label_attributes' => array('class' => 'col-sm-2 control-label')
            ),
        ));
        ...
        $this->add(array(
            'type'    => 'Zend\Form\Element\Text',
            'name'    => 'offerte_kwh_low',
            'attributes' => array('class' => 'form-control'),
            'options' => array(
                'label' => 'Offerte KWH low',
                'column-size' => 'sm-10',
                'label_attributes' => array('class' => 'col-sm-2 control-label')
            ),
        ));
        ...
        $this->add(array(
            'type'    => 'Zend\Form\Element\Text',
            'name'    => 'offerte_kwh_low_price',
            'attributes' => array('class' => 'form-control'),
            'options' => array(
                'label' => 'Offerte KWH low price',
                'column-size' => 'sm-10',
                'label_attributes' => array('class' => 'col-sm-2 control-label')
            ),
        ));
